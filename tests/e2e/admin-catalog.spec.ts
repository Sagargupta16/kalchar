...
/**
 * Pixel checks the harness cannot make. Needs `pnpm dev:preview` on 3010:
 *   KALCHAR_ADMIN_PREVIEW=1 pnpm exec playwright test --config tests/admin/playwright.config.ts tests/e2e/admin-catalog.spec.ts -g "@preview"
