...
| [DATABASE.md](DATABASE.md) | Neon Postgres + Drizzle. Schema (artworks / workshops / categories / order_presets / maintainers), the data seam, row mapping, writes, migrations + seed. |
